...
public class WalletTest {
    ...
    public void before(){
        ...
        creditCard = new CreditCard("1111222233334444", "12/23", 234, CardType.PERSONAL);
        debitCard = new DebitCard("1111222233334444", 909090, 12345678, "12/23", 234, CardType.BUSINESS);
    ...
    @Test
    public void canScanAnyscannableCard(){
        assertEquals("Payment Successful", wallet.scan(creditCard));
        assertEquals("123456787890", wallet.scan(loyaltyCard));
        assertEquals("Payment Complete", wallet.scan(debitCard));
        assertEquals("QWERTY123456", wallet.scan(ticket));
    }
}
